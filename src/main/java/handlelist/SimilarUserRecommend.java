...
public class SimilarUserRecommend {
  ...
  public SimilarUserRecommend(HashMap<String, Double> userList) {
    this.handleList = new HandleList();
    this.userList = userList;
  }

  public SimilarUserRecommend(HashMap<String, Double> userList, String genre) {
    this.handleList = new HandleList();
    this.userList = userList;
    this.genre = genre;
  }
