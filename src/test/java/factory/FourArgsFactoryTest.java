...
public class FourArgsFactoryTest {
  ...
  public void testNegativeAgeCheckValidity() {
    ...
    assertTrue(actualInput.checkValidity(input)
        .equals("Wrong age input. (Non-positive age) Please try again with appropriate age."));
  ...
  public void testNonIntegerAgeCheckValidity() {
    ...
    assertTrue(actualInput.checkValidity(input)
        .equals("Wrong age input. (Not an integer) Please try again with appropriate age."));
  ...
  public void testGenderCheckValidity() {
    ...
    assertTrue(actualInput.checkValidity(input)
        .equals("Wrong gender input. Please try again with F for female or M for male."));
  ...
  public void testOccupationCheckValidity() {
    ...
    assertTrue(actualInput.checkValidity(input).equals(String.format(
